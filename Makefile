...
dbus2mqtt: main.cpp
	...
	-I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include/ -ldbus-1 -ldbus-glib-1 -Wall -Wextra -I/home/ema-pc/Documents/DBus2MQTT -pthread \
...
dbus: sendDbusMsg.cpp
	...
	-I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include/ -ldbus-1 -ldbus-glib-1 -Wall -Wextra
